...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "alex.lyon@cabinetoffice.gov.uk"
...
management_group_settings = {
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "cabinetoffice-identity"
    }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "cabinetoffice-connectivity"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "cabinetoffice-management"
    }
  }
